...
You will use {{% resource_link "d06b63c4-7ac2-4b04-aedb-4cc76dadc0c1" "Dave's Redistricting App (DRA)" %}} to draw the districts. (Note: The app will not run in Chrome, but should work in Safari, Firefox, and Internet Explorer. You will need to download the Silverlight plugin for the app to work.)
